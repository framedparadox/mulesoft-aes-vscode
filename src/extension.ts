...
export function activate(context: vscode.ExtensionContext): void {
    ...
    context.subscriptions.push(
        ...
        vscode.commands.registerCommand('aes.encryptDecrypt', () => {
            AesPanel.render(context, () => AESEnhancedPanel.currentPanel?.refreshKeyIdentifiers());
        }),

        vscode.commands.registerCommand('aesEnhanced.encryptDecrypt', () => {
            AESEnhancedPanel.render(context, () => AesPanel.currentPanel?.refreshKeyIdentifiers());
        }),
